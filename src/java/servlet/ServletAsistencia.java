                    ...
                    if (!idInstructor.isEmpty()) {
                        ...
                        if (listaF.isEmpty() || listaF == null) {
                            ...
                            for (int j = 0; j < listaF.size(); j++) {
                                f = listaF.get(j);
                                out.println("<center>");
                                out.println("<div class='col s2 center-align hoverable' id='" + f.getId() + "' value='"+f.getNumeroFicha()+"' name='cuadroFicha' onclick='tablaAprendices(this)' style='background-color: #bbdefb; padding: 5px; background-clip: content-box'><h5>" + f.getNumeroFicha() + "</h5></div>");
                                out.println("</center>");
                            }
                        }
                    } else {
