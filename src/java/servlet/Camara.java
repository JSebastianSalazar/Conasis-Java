 ...
 * @author sebas
 */
public class Camara extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String foto = (String) session.getAttribute("usuario1");
            ...
            try {
                ...
                FileOutputStream output = new FileOutputStream("C:\\Users\\sebas\\Desktop\\CONASIS_MENU_Eldrin\\conasis\\web\\" + rut);
                String ruta = "" + rut;
